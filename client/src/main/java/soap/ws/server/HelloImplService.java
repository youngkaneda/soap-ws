 ...
 * 
 */
@WebServiceClient(name = "HelloImplService", targetNamespace = "http://server.ws.soap/", wsdlLocation = "file:/media/juan/DATA/linux/sistemas-distribuidos/soap-ws/client/src/main/java/service.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLSERVICE_QNAME = new QName("http://server.ws.soap/", "HelloImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/media/juan/DATA/linux/sistemas-distribuidos/soap-ws/client/src/main/java/service.wsdl");
    ...
    public Hello getHelloImplPort() {
        return super.getPort(new QName("http://server.ws.soap/", "HelloImplPort"), Hello.class);
    }
    ...
    public Hello getHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.ws.soap/", "HelloImplPort"), Hello.class, features);
    }
